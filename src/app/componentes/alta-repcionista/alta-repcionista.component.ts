...
@Component({
  selector: 'app-alta-recepcionista',
  templateUrl: './alta-repcionista.component.html',
  styleUrls: ['./alta-repcionista.component.css']
})
export class AltaRepcionistaComponent implements OnInit {
